...
#（8）階層的重回帰分析
ステップ1で「性別」、ステップ2で「知覚された学校環境変化」「HSCS」、ステップ3で「知覚された学校環境変化×HSCS」を独立変数として順に投入。独立変数は「性別」以外、中心化。HSCSは1時点目の得点を用いる。従属変数はwell-beingの潜在差得点。
参考資料として：chrome-extension://oemmndcbldboiebfnladdacbdfmadadm/http://cogpsy.educ.kyoto-u.ac.jp/personal/Kusumi/datasem13/shinya2.pdf
